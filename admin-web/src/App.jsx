  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      ...
      <div
        ...
        style={{ flex: 1, display: 'flex', flexDirection: 'column', marginLeft: 'var(--sidebar-width)' }}
      >
        <TopBar currentPage={currentPage} onMenuClick={() => setSidebarOpen(v => !v)} />
        <main style={{
          flex: 1,
          padding: 32,
          background: 'var(--bg)',
    ...
    <AuthContext.Provider value={{ user, loading, setUser }}>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/plans" element={<ProtectedRoute currentPage="Planes"><Plans /></ProtectedRoute>} />
          <Route path="/subscriptions" element={<ProtectedRoute currentPage="Suscripciones"><Subscriptions /></ProtectedRoute>} />
